export default function Button({ 
    ...
    const variants = {
        primary: 'bg-blue-500 text-white hover:bg-blue-600 active:bg-blue-700 rounded-md',
        secondary: 'bg-gray-100 text-gray-700 hover:bg-gray-200 active:bg-gray-300 rounded-md',
        ...
        'icon-primary': 'text-blue-500 hover:bg-blue-50 active:bg-blue-100 rounded-full',
